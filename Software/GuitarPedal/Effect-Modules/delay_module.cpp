...
static const ParameterMetaData s_metaData[s_paramCount] = {{name: "Delay Time", valueType: ParameterValueType::Float, valueBinCount: 0, defaultValue: {.float_value = 0.5f}, knobMapping: 0, midiCCMapping: 14},  //mod
                                                           {name: "D Feedback", valueType: ParameterValueType::Float, valueBinCount: 0, defaultValue: {.float_value = 0.5f}, knobMapping: 1, midiCCMapping: 15},
                                                           {name: "Delay Mix", valueType: ParameterValueType::Float, valueBinCount: 0, defaultValue: {.float_value = 0.5f}, knobMapping: 2, midiCCMapping: 16},

                                                           {name: "Delay Mode", valueType: ParameterValueType::Binned, valueBinCount: 3, valueBinNames: s_delayModes, defaultValue: {.uint_value = 0}, knobMapping: 3, midiCCMapping: 17},
                                                           {name: "Delay Type", valueType: ParameterValueType::Binned, valueBinCount: 6, valueBinNames: s_delayTypes, defaultValue: {.uint_value = 0}, knobMapping: 4, midiCCMapping: 18},

                                                           {name: "Delay LPF", valueType: ParameterValueType::Float, valueBinCount: 0, defaultValue: {.float_value = 0.5f}, knobMapping: 5, midiCCMapping: 19},  //mod
                                                           {name: "D Spread", valueType: ParameterValueType::Float, valueBinCount: 0, defaultValue: {.float_value = 0.5f}, knobMapping: -1, midiCCMapping: 20}, 

                                                           {name: "Mod Amt", valueType: ParameterValueType::Float, valueBinCount: 0, defaultValue: {.float_value = 0.5f}, knobMapping: -1, midiCCMapping: 21}, 
                                                           {name: "Mod Rate", valueType: ParameterValueType::Float, valueBinCount: 0, defaultValue: {.float_value = 0.5f}, knobMapping: -1, midiCCMapping: 22}, 
                                                           {name: "Mod Param", valueType: ParameterValueType::Binned, valueBinCount: 4, valueBinNames: s_modParamNames, defaultValue: {.uint_value = 0}, knobMapping: -1, midiCCMapping: 23},
                                                           {name: "Mod Wave", valueType: ParameterValueType::Binned, valueBinCount: 5, valueBinNames: s_waveBinNames, defaultValue: {.uint_value = 0}, knobMapping: -1, midiCCMapping: 24},
                                                           {name: "Sync Mod F", valueType: ParameterValueType::Bool, defaultValue: {.uint_value = 0}, knobMapping: -1, midiCCMapping: 25}
                                                           };
...
void DelayModule::SetTempo(uint32_t bpm)
{
    ...
    else 
    {
        ...
        float magnitude = static_cast<float>(delay_in_samples - m_delaySamplesMin) / static_cast<float>(m_delaySamplesMax - m_delaySamplesMin);
