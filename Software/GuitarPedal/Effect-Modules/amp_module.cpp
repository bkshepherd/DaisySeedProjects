...
static const ParameterMetaData s_metaData[s_paramCount] = {{name: "Gain", valueType: ParameterValueType::Float, defaultValue: {.float_value = 0.5f}, knobMapping: 0, midiCCMapping: 14},
                                                           ...
                                                           {name: "Model", valueType: ParameterValueType::Binned, valueBinCount: 9, valueBinNames: s_modelBinNames, defaultValue: {.uint_value = 0}, knobMapping: 4, midiCCMapping: 18},
                                                           {name: "IR", valueType: ParameterValueType::Binned, valueBinCount: 10, valueBinNames: s_irNames, defaultValue: {.uint_value = 0}, knobMapping: 5, midiCCMapping: 19},
                                                           {name: "NeuralModel", valueType: ParameterValueType::Bool,  defaultValue: {.uint_value = 1}, knobMapping: -1, midiCCMapping: 20},
