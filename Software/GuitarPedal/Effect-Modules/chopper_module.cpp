...
static const ParameterMetaData s_metaData[s_paramCount] = {
    {name : "Wet", valueType : ParameterValueType::FloatMagnitude, valueBinCount : 0, defaultValue : 63, knobMapping : 0, midiCCMapping : 20},
...
ChopperModule::ChopperModule()
    : BaseEffectModule(), m_tempoFreqMin(0.5f), m_tempoFreqMax(4.0f), m_pulseWidthMin(0.1f), m_pulseWidthMax(0.9f), m_cachedEffectMagnitudeValue(1.0f)
...
void ChopperModule::DrawUI(OneBitGraphicsDisplay &display, int currentIndex, int numItemsTotal, Rectangle boundsToDrawIn, bool isEditing)
{
